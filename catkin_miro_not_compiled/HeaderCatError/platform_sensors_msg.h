// Generated by gencpp from file sensor_acquisition/platform_sensors_msg.msg
// DO NOT EDIT!


#ifndef SENSOR_ACQUISITION_MESSAGE_PLATFORM_SENSORS_MSG_H
#define SENSOR_ACQUISITION_MESSAGE_PLATFORM_SENSORS_MSG_H
...
namespace sensor_acquisition
{
template <class ContainerAllocator>
struct platform_sensors_msg_
{
  typedef platform_sensors_msg_<ContainerAllocator> Type;

  platform_sensors_msg_()
    : header()
    , msg_flags(0)
    , time_usec(0)
    , battery_voltage(0.0)
  ...
  platform_sensors_msg_(const ContainerAllocator& _alloc)
    : header(_alloc)
    , msg_flags(0)
    , time_usec(0)
    , battery_voltage(0.0)
  ...
  typedef boost::shared_ptr< ::sensor_acquisition::platform_sensors_msg_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::sensor_acquisition::platform_sensors_msg_<ContainerAllocator> const> ConstPtr;

}; // struct platform_sensors_msg_

typedef ::sensor_acquisition::platform_sensors_msg_<std::allocator<void> > platform_sensors_msg;

typedef boost::shared_ptr< ::sensor_acquisition::platform_sensors_msg > platform_sensors_msgPtr;
typedef boost::shared_ptr< ::sensor_acquisition::platform_sensors_msg const> platform_sensors_msgConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::sensor_acquisition::platform_sensors_msg_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::sensor_acquisition::platform_sensors_msg_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
// {'nav_msgs': ['/opt/ros/kinetic/share/nav_msgs/cmake/../msg'], 'std_msgs': ['/opt/ros/kinetic/share/std_msgs/cmake/../msg'], 'actionlib_msgs': ['/opt/ros/kinetic/share/actionlib_msgs/cmake/../msg'], 'sensor_msgs': ['/opt/ros/kinetic/share/sensor_msgs/cmake/../msg'], 'geometry_msgs': ['/opt/ros/kinetic/share/geometry_msgs/cmake/../msg'], 'sensor_acquisition': ['/home/tori/mdk/catkin_miro/src/sensor_acquisition/msg']}
...
template <class ContainerAllocator>
struct IsFixedSize< ::sensor_acquisition::platform_sensors_msg_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::sensor_acquisition::platform_sensors_msg_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::sensor_acquisition::platform_sensors_msg_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::sensor_acquisition::platform_sensors_msg_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::sensor_acquisition::platform_sensors_msg_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::sensor_acquisition::platform_sensors_msg_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::sensor_acquisition::platform_sensors_msg_<ContainerAllocator> >
{
  ...
  static const char* value(const ::sensor_acquisition::platform_sensors_msg_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x547d0cf6cf799e03ULL;
  static const uint64_t static_value2 = 0x5dff5847bb95c9ddULL;
};

template<class ContainerAllocator>
struct DataType< ::sensor_acquisition::platform_sensors_msg_<ContainerAllocator> >
{
  static const char* value()
  {
    return "sensor_acquisition/platform_sensors_msg";
  }
...
template<class ContainerAllocator>
struct Definition< ::sensor_acquisition::platform_sensors_msg_<ContainerAllocator> >
{
  static const char* value()
  {
    return "\n\
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::sensor_acquisition::platform_sensors_msg_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::sensor_acquisition::platform_sensors_msg_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::sensor_acquisition::platform_sensors_msg_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // SENSOR_ACQUISITION_MESSAGE_PLATFORM_SENSORS_MSG_H
